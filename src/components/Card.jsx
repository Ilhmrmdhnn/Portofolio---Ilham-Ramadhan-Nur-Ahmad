...
import porto13 from '../assets/card13.png';
import porto14 from '../assets/card14.png';
...
const Card = () => {
  return (
    <div className="flex flex-col lg:w-9/12 lg:flex-wrap gap-y-4 lg:flex-row w-full mb-20">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-y-4 lg:gap-4">
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Global-Air-Quality-Analytics" target="_blank" className="block relative">
            <img className="w-full rounded-lg" src={porto15} alt="card" />
            <div className="text-center mt-2 dark:text-dtitle">Global Air Quality Analytics</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
      ...
      <div className="text-center my-8">
        <span className="text-lg font-semibold">Data Analyst</span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row w-full gap-y-4 lg:gap-4">
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Dashboard-CashFlow" target="_blank" className="block relative">
            ...
            <div className="text-center mt-2 dark:text-dtitle">Dashboard CashFlow with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Dashboard-Sales-Using-Power-BI" target="_blank" className="block relative">
            ...
            <div className="text-center mt-2 dark:text-dtitle">Dashboard Sales with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Dashboard-Online-Sales-Using-Power-BI" target="_blank" className="block relative">
            ...
            <div className="text-center mt-2 dark:text-dtitle">Dashboard Online Sales with Power BI</div>
          </a>
        </div>
      </div>
      <div className="flex flex-col lg:flex-row w-full gap-y-4 lg:gap-4">
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Flight-Operations-Dashboard" target="_blank" className="block relative">
            ...
            <div className="text-center mt-2 dark:text-dtitle">Flight Operation Dashboard with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Historical-Weather-Data-Analysis" target="_blank" className="block relative">
            ...
            <div className="text-center mt-2 dark:text-dtitle">Historical Weather Data Analysis with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-y-4 lg:gap-4">
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Comprehensive-Equipment-Analytics-Dashboard-with-Power-BI" target="_blank" className="block relative">
            <img className="w-full rounded-lg" src={porto13} alt="card" />
            <div className="text-center mt-2 dark:text-dtitle">Comprehensive Equipment Analytics Dashboard with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Global-Air-Quality-Analysis-Power-BI-Report" target="_blank" className="block relative">
            <img className="w-full rounded-lg" src={porto14} alt="card" />
            <div className="text-center mt-2 dark:text-dtitle">Global Air Quality Analysis Dashboard with Power BI</div>
          </a>
        </div>
        <div className="lg:flex-1 relative">
          <a href="https://github.com/Ilhmrmdhnn/Pizza-Store-Sales-Dashboard-with-Power-BI" target="_blank" className="block relative">
            <img className="w-full rounded-lg" src={porto17} alt="card" />
            <div className="text-center mt-2 dark:text-dtitle">Pizza Store Sales Dashboard with Power BI</div>
          </a>
        </div>
      </div>
